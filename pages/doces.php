    ...
    <article class="card recipe"> 
      <!-- Cabeçalho da receita -->      
        <div class="recipe-header">
          <img class="recipe-cover" src="img/bolo-cenoura.jpeg" alt="Bolo de Cenoura" itemprop="image">
        ...
        <div class="grid">
          <section class="ingredientes" aria-label="titulo-ingredientes">
          ...
          <section class="preparo" aria-label="titulo-preparo">
            <h3 id="titulo-preparo">Modo de Preparo</h3>
            <ol class="itens-ingredientes">
      ...
      <!-- <div class="actions">
        ...
        <button class="btn secondary" onclick="navigator.clipboard.writeText(window.location.href)">Copiar link</button>
      </div> -->
    </article>
